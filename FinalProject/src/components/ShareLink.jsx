  ...
  return (
    <div className="cuenta_container">
      <div className="icon-arrow">
            <Icon icon="formkit:arrowleft" style={{margin:"25px 15px 0px 15px", width:"30px", height:"30px", color:"#F8B908"}}/>
     </div>
      ...
      <img src="../static/logo2.png" alt="" />
          ...
          <Icon icon="icon-park-solid:copy-link"style={{margin:"15px 5px 0px 95px", width:"90px", height:"90px", color:"#D5D765"}} /> 
          </div>
